package de.developer66.codearea;
...
public class CustomCodeArea {
	...
	public void start() {
		...
		codeArea.richChanges().filter(ch -> !ch.getInserted().equals(ch.getRemoved())) // XXX
				.successionEnds(Duration.ofMillis(50)).supplyTask(this::computeHighlightingAsync)
		...
		codeArea.getStylesheets().add(CodeArea.class.getResource("/editorStyle.css").toExternalForm());
	}
